...
static char CopyrightMsg1[] = "mTCP Ping by M Brutman (mbbrutman@gmail.com) (C)opyright 2009-2011\n";
...
int main( int argc, char *argv[] ) {
  ...
  uint16_t icmpLen = PacketPayload + sizeof( IcmpHeader ) + sizeof( uint16_t ) * 2;
...
void sendAndWait( ) {
  ...
  Packet_send_pkt( &icmpEchoPacket, sizeof( icmpEchoPacket ) );
