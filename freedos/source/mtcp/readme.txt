...
Code structure
  ...
  the individual OBJ files.  It's basically the same as a library
...
Compilers
  ...
  environments.  I've since abandoned that strategy and have moved
...
Future direction
  ...
  I'd like to spread the joy of DOS TCP/IP programming to more people.
