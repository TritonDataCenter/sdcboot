...
static void 
ShowStatus(unsigned long sector, unsigned long endsector);
...
main (int argc, char *argv[])
{
  ...
  unsigned long total, disksize, allocated, beginsector;
  unsigned long FilledDiskSize, FilledTotal, FileSize = 0;
  unsigned long sector, endsector;
...
ShowStatus(unsigned long sector, unsigned long endsector)
{
  printf(" (%04lu/%04lu)\b\b\b\b\b\b\b\b\b\b\b\b",sector,endsector);
}
