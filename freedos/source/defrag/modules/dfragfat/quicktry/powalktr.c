...
/*
   ...
   30-05-07
      ...
      Changed to use a post order traversal, so that we can change the on disk directory tree, 
      without ending up with invalid data structures.
                      ...
                      void** structure)
{
    ...
    else
    {
       if (top) /* Be carefull when there are no sub directories
         in the volume. */
       {
               /* Call the function for every file in the directory we just left */
